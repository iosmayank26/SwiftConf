...
final class ConferenceListVM {
    ...
    private var confModel: [ConferenceModel]
    ...
    // MARK: - Methods to handle model data
    ...
    func getConfImageOnIndex(index: Int) -> String {
        return confModel[index].image
    }
    
    func getConfDescriptionOnIndex(index: Int) -> String {
        return confModel[index].description
    }
}
